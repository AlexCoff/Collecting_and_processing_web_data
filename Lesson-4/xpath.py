...
class news():
    def __init__ (self):
        ...
        self.__ylink = 'https://yandex.ru/news/'
        self.__news =[]
    @staticmethod
    ...
    def __parse_mail_news(self,link):
        ...
        raw_time = dom.xpath("//div[@class='cols__inner']/div[contains(@class,'article')]/div[1]/span[1]/span/span/@datetime")[0]
    ...
    def parse_lenta(self):
        ...
        first_news = dom.xpath("//section[@class='row b-top7-for-main js-top-seven']/.//div[contains(@class,'first-item')]")
        f_news['header'] = first_news[0].xpath("./h2/a/text()")[0]
        f_news['url'] = self.__llink + first_news[0].xpath("./h2/a/@href")[0]
        f_news['time'] = first_news[0].xpath("./h2/a/time/@datetime")[0]
        ...
        for block in news_block:
            ...
            news['time'] = block.xpath("./a/time/@datetime")[0]
